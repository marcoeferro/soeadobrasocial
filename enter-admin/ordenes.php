...
<head>
    ...
    <title>SOEAD - Lista de órdenes</title>
...
<body class="admin">
    ...
    <div class="body-main">
                ...
                <div class="d-flex">
                    <li class="nav-item dropdown">
                        ...
                        <ul style="border-radius:20px ;" class="dropdown-menu">
                            <a href="./afiliados-lista.php" class="login-header-button"><button>Ver afiliados</button></a>
        ...
        <div class="table-container">
            <h3>LISTADO DE ÓRDENES SOLICITADAS</h3>
            <table id="tablaOrdenes">
                <thead>
                    <tr>
                        <th scope="col">Nombre del afiliado</th>
                        <th scope="col">Número del afiliado</th>
                ...
                <tbody style="padding:5px ;width:100%">
                    <!-- Acá va el contenido de la tabla -->
                </tbody>
            </table>
        </div>
    ...
    <div class="modal fade" id="modalPagado" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Marcar orden como no abonada</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    ¿Desea marcar la orden como no abonada?
                </div>
                <div class="modal-footer">
    ...
    <!-- Modal para marcar como no pagada-->
    <div class="modal fade" id="modalNoPagado" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Marcar orden como bbonada</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    ¿Desea marcar la orden como abonada?
                </div>
                <div class="modal-footer">
                    <input type="hidden" id='eliminarid' name='eliminarid'>
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
...
<script src="./../enter-admin/js/datatTableOrdenes.js"></script>
...
<script>
    ...
    function noPagada(id) {
        $('#eliminarid').val(id);
        $('#modalNoPagado').modal('show');
    }
    function eliminar() {
