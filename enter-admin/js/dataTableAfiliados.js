        ...
        columns: [
            ...
            { data: "id_afiliado" , data:"nro_afiliado",
                'fnCreatedCell': function (nTd, sData, oData, iRow, iCol) {
                    $(nTd).html("<div style='display:inline-flex;position:abosolute;justify-content:space-between;'><div style='margin-right:5px;margin-left:5px;'><form action='./modificacion-afiliado.php' method='post'><input type='hidden' name='id-modificar' value='" + oData['id_afiliado'] + "' /><input class='btn btn-secondary' style='margin-right:2px;' type='submit' Value='Modificar'></form></div><div style='margin-right:5px;margin-left:5px;'><form action='./grupo-familiar.php' method='post'><input type='hidden' name='id-afiliado' value='" + oData['nro_afiliado'] + "' /><input class='btn btn-primary' style='margin-right:2px;' type='submit' Value='Grupo Familiar'></form></div><div style='margin-right:5px;margin-left:5px;'><form action='./acciones/eliminar-afiliado.php' method='post' id='form_eliminar_" + oData['id_afiliado'] + "'><input type='hidden' name='vienedelform' value='" + oData['id_afiliado'] + "' /><button type='button' name='Eliminar' Value='Eliminar' class='input btn btn-danger' style='border-radius:15px;height:48px;margin-right:2px;' onclick=alerta(" + oData['id_afiliado'] + ")>Eliminar</button></form></div></div>");
                }
            }
        ],
        columnDefs: [
