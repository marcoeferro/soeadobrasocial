...
?>
<!DOCTYPE html>
<!-- EN ESTE DOCUMENTO IRÍA:  (pantalla para ADministrador)
...
<head>
    ...
    <title>SOEAD - Lista de prestadores</title>
...
<body class="admin">
    ...
    <div class="body-main">
        ...
        <div class="table-container">
            <div style="display:inline-flex;justify-content:space-between">
                ...
                <a href="./nuevoprestador.php" class="login-header-button" style="margin-left: 20px;"><button style="border: 1px solid grey;">+ Añadir prestador</button></a>
            </div>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Eliminar Especialista</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    ¿Desea eliminar un especialista?
                </div>
                <div class="modal-footer">
...
<script src="./js/datatablePrestadores.js"></script>
<script>
    function alerta(id) {
        $('#eliminarid').val(id);
