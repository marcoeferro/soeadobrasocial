...
<head>
    ...
    <title>SOEAD - Modificación familiar</title>
...
<body class="admin">
    ...
    <div class="body-main">
        ...
        <div class="login-container">
            ...
            <h2>Modificar integrante familiar</h2>
            ...
            ?>
                <form id="formAfil" action="./acciones/modificar-afiliado.php" method="POST">
                    ...
                    <input required type="text" id="apellido" name="apellido" placeholder="Apellido" class="mb-4" value="<?php echo $mostrar['apellido_afiliado']; ?>">
                    <label for="fnacimiento">Fecha de nacimiento</label>
                    <input required type="date" id="fnacimiento" name="fnacimiento" class="mb-4" value="<?php echo $mostrar['fecha_nacimiento']; ?>">


                    <input required type="hidden" id="numAfil" name="numAfil" placeholder="Número de afiliado" class="mb-4" value="<?php echo $mostrar['nro_afiliado']; ?>">
