...
if (!isset($_POST['id-afiliado'])) {
    $numafiliado = $_GET['idAfiliado'];
}
...
$sql = "SELECT id_afiliado, CONCAT(nro_afiliado,'-',nro_asociado) AS datosafiliado, 
    nombre as nombrecompleto, 
    dni, fecha_nacimiento, nro_afiliado
    FROM afiliados
    WHERE eliminado = 0 AND nro_afiliado = $numafiliado
    ORDER BY nro_asociado;";
    ...
    <div class="body-main">
        ...
        <div class="table-container">
            <div style="display:inline-flex;justify-content:space-between">
                ...
                <a href="./nuevo-familiar.php?num=<?php echo $numafiliado ?>" class="login-header-button" style="margin-left: 20px;"><button style="border: 1px solid grey;">+ Agregar integrante</button></a>
            </div>
            <table id="tablaAfiliados">
                ...
                <tbody style="padding:5px ;width:100%">
                    ...
                    ?>
                        <tr style="width:100% ;">
                            <td><?php echo $fila['datosafiliado']; ?></td>
                            ...
                            <td>
                                <div class='row'>
                                    <div class='col-lg-6'>
                                        <form action='./modificacion-familiar.php' method='post'>
                                            <input type='hidden' name='id-modificar' value='<?php echo $fila['id_afiliado'] ?>' />
                                            <input class='btn btn-secondary' style='margin-right:2px;' type='submit' Value='Modificar'>
                                        </form>
                                    </div>
                                    <div class='col-lg-6'>
                                        <form action='./acciones/eliminar-afiliado.php' method='post' id='form_eliminar'>
                                            <input type='hidden' name='vienedelform' value='' id="vienedelform" />
                                            <button type='button' name='Eliminar' Value='Eliminar' class='btn btn-danger' style='border-radius:15px;height:48px;margin-right:2px;' onclick=alerta(<?php echo $fila['id_afiliado'];?>)>Eliminar</button>
                                        </form>
                                    </div>
                                </div>
                            </td>
