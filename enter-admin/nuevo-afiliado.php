...
<head>
    ...
    <title>SOEAD - Nuevo afiliado</title>
...
<body class="admin">
    ...
    <div class="body-main">
        ...
        <form id="formAfil" method="POST" action="./acciones/create-afiliado.php">
            <div class="login-container" style="width: 45%;">
                <h2>Añadir nuevo afiliado títular</h2>
                ...
                <div style="width:50% ;"><label for="numero-afil">Ingrese número de afiliado</label>
                    <input required min="10000" min="99999" type="number" id="numero-afil" name="numero-afil" placeholder="00000" class="mb-4" ></div>
                    
                    <div style="width:45% ;">
                    <label for="n-asoc">Identificador familiar</label> <!-- se puede mejorar -->
                    <input min="10000" minlength="99999" type="number" id="n" name="n" placeholder="00" class="mb-4" disabled value ='00'>
                    <input type="hidden" id="n-asoc" name="n-asoc"value ='00'>    
                </div>
                </div>

                <label for="dni">Ingrese DNI</label>
                <input required min="10000000" max="99999999" type="number" id="dni" name="dni" placeholder="DNI sin puntos" class="mb-4">
