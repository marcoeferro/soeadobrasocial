...
<div class="spinner-container" id="page-loader">
    ...
    <nav class="navbar" style="margin-top: 1vh;">
            <div class="container-fluid">
                ...
                <div class="d-flex">
                    <a href="./afiliados.php" class="login-header-button" style="margin-left: 20px;"><button style="padding:8px; background-color:lightslategrey;color:white;">Volver atrás</button></a>
      ...
      <div class="">      
          ...
          if($resultado==1){
            echo '<div style="vertical-align: middle;text-align: center;">
                    <p>Se añadieron los prestadores correctamente</p> 
                ...
                echo '<div style="vertical-align: middle;text-align: center;">
                    ...
                    <a href="./prestadores.php" class="btn btn-success" style="margin-left: 20px;">
                        Volver a cargar
                    </a>
                </div>';
            }
