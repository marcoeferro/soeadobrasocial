...
<body class="admin">
    ...
    <div class="body-main">
        ...
        <form id="formRecuperacion" method="POST" action="./recuperar-admin.php">
            <div class="login-container">
                <div class="login-card">
                    <div class="login-card-title">
                        <h5>Gestión de SOEAD</h5>
                        <p>Recuperación cuenta</p>
                    </div>
                    <div class="login-card-body">
                        <label for="usuario">Ingrese correo electrónico</label>
